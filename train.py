...
def fit_model_softmax(
    ...
    early_stopping = EarlyStopping(
        monitor="val_accuracy", min_delta=0.001, patience=20, verbose=1, mode="max"
    )
...
def start_training(working_dir, pre_training_phase=True):
    ...
    if pre_training_phase:
        ...
        dsm = DeepSpeakerModel(
            batch_input_shape, include_softmax=True, num_speakers_softmax=num_speakers_softmax
        )
